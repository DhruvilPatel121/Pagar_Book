...
const TaskRequest = () => {
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-sm">
      ...
      <div>
        <h1 className="text-xl font-semibold pb-2">Tasks Request</h1>
        <p className="text-sm text-gray-500 pb-4">Access request tasks of your staff here</p>
      </div>
